  ...
  return (
    <div className='mt-10'>
      ...
      <div className='mt-5 flex items-center justify-center'>
        <button className='mx-3 rounded-full bg-gradient-to-br from-sub to-purple px-8 py-3 font-semibold text-txt dark:text-white/80'>
          Get Started
        </button>

        <button className='flex items-center rounded-full border-[2px] border-purple px-6 py-3 font-semibold text-txt dark:text-white/80 lg:px-10'>
          Watch Now
